...
および「阪神―中日（2026年7月16日 バンテリンドーム）」のような対戦カード表記(`MATCHUP_SEPARATORS`で判定)での
言及は、いずれも対戦相手としての言及とみなして除外する処理が入っています(`isMatchupCardMention`)。後者は、
見出しに主役の球団名しかなくても、本文冒頭の「◇セ・リーグ ○○―●●」という対戦カード表記経由で相手球団まで
